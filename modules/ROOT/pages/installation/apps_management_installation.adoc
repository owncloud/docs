...
image:/server/_images/oc_admin_apps.png[image]
...
6.  If you’re using a cache, such as xref:configuration/server/caching_configuration.html#clearing-the-redis-cache[Redis] or xref:configuration/server/caching_configuration.html#clearing-the-memcached-cache[Memcached], ensure that you clear the cache.
