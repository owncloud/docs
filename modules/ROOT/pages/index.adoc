...
* {docs-base-url}/server/10.3/admin_manual/[Administration Manual]
  ({docs-base-url}/server/10.3/ownCloud_Server_Administration_Manual.pdf[Download PDF])
* {docs-base-url}/server/10.3/developer_manual/[Developer Manual]
  ({docs-base-url}/server/10.3/ownCloudDeveloperManual.pdf[Download PDF])
* {docs-base-url}/server/10.3/user_manual/[User Manual]
  ({docs-base-url}/server/10.3/ownCloud_User_Manual.pdf[Download PDF])

=== ownCloud 10.2

* {docs-base-url}/server/10.2/admin_manual/[Administration Manual]
  ({docs-base-url}/server/10.2/ownCloud_Server_Administration_Manual.pdf[Download PDF])
* {docs-base-url}/server/10.2/developer_manual/[Developer Manual]
  ({docs-base-url}/server/10.2/ownCloudDeveloperManual.pdf[Download PDF])
* {docs-base-url}/server/10.2/user_manual/[User Manual]
  ({docs-base-url}/server/10.2/ownCloud_User_Manual.pdf[Download PDF])
