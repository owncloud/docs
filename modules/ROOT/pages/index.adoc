...
* xref:latest@administration_manual:index.adoc[Administration Manual] (Download PDF)
* xref:latest@developer_manual:index.adoc[Developer Manual] (Download PDF)
* xref:latest@user_manual:index.adoc[User Manual] (Download PDF)
...
* xref:latest@administration_manual:appliance/what-is-it.adoc[ownCloud X Appliance Manual]
...
* xref:latest@desktop:ROOT:index.adoc[ownCloud Desktop Client Manual]
  (Download PDF)

=== ownCloud Android App

* xref:latest@android:ROOT:index.adoc[ownCloud Android App Manual]
  (Download PDF)

=== ownCloud iOS App

* xref:latest@ios:ROOT:index.adoc[ownCloud iOS App Manual]
  (Download PDF)
