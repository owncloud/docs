...
// this section will be deleted when the new IOS client is released.

On the iOS platform, the team is preparing the 12.0 release which will fully support spaces. It is available in our https://owncloud.com/beta-testing/#ios[public TestFlight beta program].
