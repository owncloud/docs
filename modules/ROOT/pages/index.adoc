...
The web interfaces integrated in ownCoud Infinite Scale and owncloud Server give users native access to their ownCloud cloud data. With no needs for user sided installations, one can just access his data securely from all over the world with just a browser. 
