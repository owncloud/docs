...
* xref:master@admin_manual:index.adoc[Administration Manual]
  (https://doc.owncloud.com/server/10.0/admin_manual/ownCloud_Admin_Manual.pdf[Download PDF])
* xref:master@developer_manual:index.adoc[Developer Manual]
  (https://doc.owncloud.com/server/10.0/developer_manual/ownCloud_Developer_Manual.pdf[Download PDF])
* xref:master@user_manual:index.adoc[User Manual]
  (https://doc.owncloud.com/server/10.0/user_manual/ownCloud_User_Manual.pdf[Download PDF])
...
* https://doc.owncloud.com/server/9.0/admin_manual/[Administration Manual]
...
* https://doc.owncloud.com/server/8.2/admin_manual/[Administration Manual]
