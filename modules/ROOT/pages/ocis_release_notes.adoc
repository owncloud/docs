...
The fulltext search can now be activated by users through selecting the btn:[Search only in content] filter chip located on the search results page. This takes away the need of inputting search syntax. https://github.com/owncloud/web/pull/9294[#9294]
