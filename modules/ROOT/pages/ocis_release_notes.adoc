...
Infinite Scale is the latest generation of the ownCloud server application.
...
For the sake of efficiency, Infinite Scale reduces dependencies and works without a traditional database. This saves administration efforts, hardware resources and energy.
...
Along with the release of the Infinite Scale server component also the new major version 3.0 of the ownCloud desktop client will be released. Version 3.0 is fully compatible with Infinite Scale as well as the recent ownCloud 10 Server.
...
|                              | Notifications                                                               | Framework to inform users about events in the platform; email notification for the event “Share received”                                            
...
|                              | Technical service metrics                                                   | Load, memory usage, etc. per Infinite Scale service                                                                                                           
...
|                              |                                                                             |                                                                                                                                                     
| Deployment                   |                                                                             |                                                                                                                                                     
|                              | Single binary                                                               | The simplest way to deploy Infinite Scale for testing purposes                                                                                   
