...
- We added a config option for cross-origin resource sharing (CORS) which, for example, allows running the Web UI on another domain.  [#5987](https://github.com/owncloud/ocis/pull/5987)
...
- We added the possibility to restrict the creation of public links based on user roles (permission). [#5690](https://github.com/owncloud/ocis/pull/5690)

- Added possibility to assign roles based on OIDC claims: [#6048](https://github.com/owncloud/ocis/pull/6048)

- Default quota based on user role: With this enhancement roles can now be configured with a default quota (eg. Admins should have a default quota of 100GB, Users should have a default quota of 50GB). [#5616](https://github.com/owncloud/ocis/pull/5616)
