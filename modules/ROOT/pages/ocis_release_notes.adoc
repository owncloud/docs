...
The most prominent changes in **Infinite Scale 2.0.0 beta7** and ownCloud Web 5.7.0 comprise:

* Files and folders can now be cut/copy/pasted across Spaces using either action buttons after selecting them or by using well-known keyboard shortcuts. The former copy/paste dialog has been removed. https://github.com/owncloud/web/pull/7309[web#7309]
* The general Web interface has a more condensed appearance. https://github.com/owncloud/web/pull/7363[web#7363]
