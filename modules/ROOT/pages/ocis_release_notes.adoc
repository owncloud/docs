...
* Web Office applications (like ONLYOFFICE or Collabora Online) will now obey the language setting of the ownCloud Web interface. https://github.com/owncloud/ocis/pull/4399[ocis#4399] https://github.com/cs3org/reva/pull/3156[cs3org/reva#3156] https://github.com/owncloud/ocis/issues/4367[ocis#4367]
