...
The Cloud Importer is disabled by default. To enable this extension, please refer to the WOPI Docker Compose Deployment Example: https://github.com/owncloud/ocis/pull/6702
...
=== Breaking Changes
- Usage of Web UI and ownCloud 10 as backend is not recommended starting with version 7.1.0. of the Web UI. If you want to use the Web UI with ownCloud 10, please use version 7.0.2 where we'll fix critical bugs upon request.  
