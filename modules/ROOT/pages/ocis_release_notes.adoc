...
Infinite Scale 2.0.0 beta6 includes a huge number of bug fixes, cosmetic and performance improvements. It also brings a large number of bug fixes further hardening the 'Spaces' feature.
...
* File search will now report the number of results shown (if there are more than actually shown). https://github.com/owncloud/web/pull/7267[web#7267]
