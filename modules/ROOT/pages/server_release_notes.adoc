...
* An index is going to be added on the oc_filecache table which should help to speed-up bulk file operations. https://github.com/owncloud/core/pull/40633[#40633]
