...
Dear ownCloud administrator, find below the changes and known issues in ownCloud Server 10.12 that need your attention. You can also read {oc-changelog-url}[the full ownCloud Server changelog] for further details on what has changed.
...
Support for security fixes for PHP 7.3 ended in December 2021. ownCloud core no longer supports PHP 7.3 therefore ensure that you are using PHP 7.4. https://github.com/owncloud/core/pull/40394[#40394]
