...
The Guests App Whitelist feature is evaluating the whitelist stricter with this new release, therefore the Administrator needs to make sure that essential core apps are added before performing the upgrade:
* admin_audit 
* encryption
* files_antivirus
* firewall
...
Any app that provides access to external storage the guest users should have access too need to be added as well:
* files_primary_s3
