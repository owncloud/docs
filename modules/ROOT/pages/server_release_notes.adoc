...
The _Guests App Whitelist feature_ is evaluating the whitelist stricter starting with release 0.12.0 . Therefore the administrator needs to make sure that essential core apps are added _before_ performing the upgrade:
...
Any apps that provide access to external storage the guest users should have access too, need to be added as well like:
