...
There is a performance impact related to federated sharing in ownCloud Server 10.13.2.
Possible workaround: [Revert via diff](https://patch-diff.githubusercontent.com/raw/owncloud/core/pull/41014.diff)
