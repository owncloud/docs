...
ownCloud Server 10.9.1 is a bug fix and maintenance release.
You can read {owncloud-server-changelog-url}[the full ownCloud Server changelog] for further details on what has changed.

=== Solved known issues
All https://doc.owncloud.com/server/next/server_release_notes.html#known-issues[known issues] in Server 10.9.0 have been fixed:
