...
All xref:server_release_notes.adoc#known-issues[known issues in Server 10.8] have been fixed.
...
When an encrypted file gets overwritten by a share recipient, the file gets corrupted. This means, that the latests changes will be lost. If  https://doc.owncloud.com/server/next/admin_manual/configuration/files/file_versioning.html[Files Versions] was enabled, you can restore the previous version. This occurs only if https://doc.owncloud.com/server/next/admin_manual/configuration/files/encryption/[encryption] is enabled. If you use encryption, we recommend not to update to ownCloud 10.9.0 but wait until 10.9.1 will be released in early January 2022. https://github.com/owncloud/core/pull/39623[Find here more technical details on the issue]
...
All xref:server_release_notes.adoc#known-issues[known issues from Server 10.7] have been fixed.
