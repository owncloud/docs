...
* An index is going to be added on the oc_filecache table which should help to speed-up bulk file operations. Plase be aware that this migration step may take several hours in case of installations where the oc_filecache table contains a significant large amount of entries. https://github.com/owncloud/core/pull/40633[#40633]
