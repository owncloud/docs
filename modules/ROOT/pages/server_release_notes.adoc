...
All xref:server_release_notes.adoc#known-issues-10-13-1[known issues] in Server 10.13.1 have been fixed:
...
* https://marketplace.owncloud.com/apps/wopi [Microsoft Office Online]: 1.8.1

=== Known Issues

Currently there are no known issues with ownCloud Server 10.13.2. This section will be updated if issues are discovered. 
