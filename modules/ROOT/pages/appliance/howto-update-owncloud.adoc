...
image:/server/_images/appliance/ucs/upgrade-owncloud/univention-management-console-software-update-highlighted.png[image]
...
image:/server/_images/appliance/ucs/upgrade-owncloud/univention-software-update-dashboard.png[image]

When there, part-way down the page you’ll see the ``**Manage local
installation**'' section. Under there, click ``**UPGRADE**''.

image:/server/_images/appliance/ucs/upgrade-owncloud/owncloud-app-ready-for-update.png[image]
...
image:/server/_images/appliance/ucs/upgrade-owncloud/owncloud-update-app-installation-notes.png[image]
...
image:/server/_images/appliance/ucs/upgrade-owncloud/confirm-owncloud-upgrade.png[image]
...
image:/server/_images/appliance/ucs/upgrade-owncloud/installed-applications-owncloud.png[image]
...
image:/server/_images/appliance/ucs/upgrade-owncloud/begin-owncloud-uninstall.png[image]

This takes you to an uninstall confirmation page. On that page, click
UNINSTALL on the lower left-hand side of the page.

image:/server/_images/appliance/ucs/upgrade-owncloud/confirm-owncloud-uninstall.png[image]
...
image:/server/_images/appliance/ucs/upgrade-owncloud/app-center-search-for-owncloud.png[image]
...
image:/server/_images/appliance/ucs/upgrade-owncloud/owncloud-app-version-confirmation.png[image]
...
image:/server/_images/appliance/ucs/upgrade-owncloud/owncloud-confirm-install.png[image]
