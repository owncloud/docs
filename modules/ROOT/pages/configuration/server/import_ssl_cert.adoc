...
image:/server/_images/configuration/server/import-ssl-cert-1.png[image]
...
image:/server/_images/configuration/server/import-ssl-cert-2.png[Click ''More information'' in Firefox to import SSL certificate]
...
image:/server/_images/configuration/server/import-ssl-cert/import-ssl-root-certificates-admin.png[Import Root SSL Certificate in ownCloud]
