...
image:/server/_images/configuration/server/security/password-policy-app.png[image]
...
image:/server/_images/configuration/server/security/security-app-password-policy.png[]
