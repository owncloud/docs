...
- `-m` stands for the method. method accepts arguments `recovery` or `password`. If recovery method is chosen then the recovery password will be used to decrypt files. If password method is chosen then individual user passwords will be used to decrypt files.
...
Description about continue option
