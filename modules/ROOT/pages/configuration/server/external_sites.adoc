...
image:/server/_images/external-sites-1.png[Click to enlarge]
...
image:/server/_images/external-sites-4.png[image]

On this page, X-Frame-Options prevents the embedding.

image:/server/_images/external-sites-5.png[image]
