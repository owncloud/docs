...
image:/server/_images/users-config-2.png[image]
...
image:/server/_images/users-create.png[image]
...
image:/server/_images/users-groups.png[image]
...
image:/server/_images/custom-groups/owncloud-market-custom-groups.png[The Custom Groups application in the ownCloud Market]

1.  Click ``**INSTALL**'' in the bottom right-hand corner of the Custom
Groups application.

image:/server/_images/custom-groups/owncloud-market-custom-groups-install.png[Install the Custom Groups application from the ownCloud Market]
