...
image:/server/_images/enterprise/firewall/firewall-1.png[Figure 1: Empty File Firewall configuration
panel]
...
image:/server/_images/enterprise/firewall/firewall-2.png[Figure 2: Two example rules that restrict
...
image:/server/_images/enterprise/firewall/firewall-3.png[image]
