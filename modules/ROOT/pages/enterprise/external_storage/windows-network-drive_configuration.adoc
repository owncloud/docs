...
image:/server/_images/enterprise/external_storage/wnd-1.png[Figure 1: Windows Network Drive share on your
Files page.]
...
image:/server/_images/enterprise/external_storage/wnd-2.png[Figure 2: WND mountpoint and authorization
credentials.]
...
image:/server/_images/enterprise/external_storage/wnd-3.png[Figure 3: WND server, credentials, and
