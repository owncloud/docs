...
image:/server/_images/issues/code-integrity-notification.png[Code integrity warning banner.]
...
image:/server/_images/issues/code-integrity-admin.png[Links for resolving code integrity warnings.]
