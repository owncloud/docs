...
* xref:{latest-server-version}@server:admin_manual:index.adoc[Administration Manual]
...
* xref:{latest-server-version}@server:user_manual:index.adoc[User Manual]
...
* xref:{previous-server-version}@server:user_manual:index.adoc[User Manual]
