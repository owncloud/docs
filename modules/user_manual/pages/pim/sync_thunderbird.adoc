...
image:/server/user_manual/_images/contact_thunderbird-Symbol_Gear.jpg[image]
...
image:/server/user_manual/_images/contact_thunderbird-Symbol_Impeller.jpg[image]

which will display the URL you need for your installation to work.

image:/server/user_manual/_images/contact_thunderbird-URL_config.jpg[image]
