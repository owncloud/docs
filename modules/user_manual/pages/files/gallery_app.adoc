...
IMPORTANT: This app has been superseded by {media-viewer-app-url}[the Media Viewer app].
...
=== Remove Gallery Directories

Checked the ownCloud installation's data folder, and remove any legacy gallery folders that still exist; e.g., `/var/www/owncloud/data/<username>/gallery/`.
