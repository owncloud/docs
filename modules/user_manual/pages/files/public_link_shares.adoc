...
| Show file listing
| The option allows recipients to list the files in the shared folder. 
If you don’t give permission to view the files you have xref:files/webgui/sharing.adoc#creating-drop-folders[a drop folder].
