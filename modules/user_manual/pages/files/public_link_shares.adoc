...
image:/server/user_manual/_images/public-link/create-public-link.png[Create a public link - step one.]
...
image:/server/user_manual/_images/public-link/public-link-settings.png[Create a public link - step two.]
