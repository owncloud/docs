...
[source,bash]
----
sudo curl -u user:pass -X MKCOL "https://example.com/owncloud/remote.php/webdav/$(date '+%d-%b-%Y')"
----
...
[source,bash]
----
sudo curl -u user:pass -T error.log "https://example.com/owncloud/remote.php/webdav/$(date '+%d-%b-%Y')/error.log"
----
...
[source,bash]
----
sudo curl -u user:pass -X MOVE --header 'Destination: https://example.com/owncloud/remote.php/webdav/target.jpg' https://example.com/owncloud/remote.php/webdav/source.jpg
----
...
[source,bash]
----
sudo curl -X PROPFIND -H "Depth: 1" -u user:pass https://example.com/owncloud/remote.php/webdav/ | xml_pp
