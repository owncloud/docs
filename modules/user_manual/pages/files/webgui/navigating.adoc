...
You can play videos in ownCloud with the Media Player app, by clicking once on the file. 
Please note, video streaming by the ownCloud Media Player depends on your web browser and the video’s format.
