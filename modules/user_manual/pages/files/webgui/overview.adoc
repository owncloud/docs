...
image:/server/user_manual/_images/files_file-controls.png[image]
...
image:/server/user_manual/_images/files_mark-as-favorite.png[image]
...
image:/server/user_manual/_images/files_page-3.png[image]
...
image:/server/user_manual/_images/files_page-4.png[image]
