...
image:/server/user_manual/_images/files_page-5.png[image]
...
image:/server/user_manual/_images/files_share-options.png[image]
...
image:/server/user_manual/_images/files_page-2.png[image]
...
image:/server/user_manual/_images/sharing/restore-files.png[image]
...
image:/server/user_manual/_images/guest-users/share-with-guest-users.png[Sharing with guest users.]
...
image:/server/user_manual/_images/guest-users/content-shared-with-guest-user.png[Content shared with a guest user.]
...
image:/server/user_manual/_images/public-link/private-link.png[Obtaining a private link for a shared file or folder]
...
image:/server/user_manual/_images/sharing/create-drop-folder.png[Create a Drop Folder]
...
image:/server/user_manual/_images/sharing/use-drop-folders.png[Using Drop Folders]
