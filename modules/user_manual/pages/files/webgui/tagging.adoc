...
image:/server/user_manual/_images/file_popup-menu.png[image]
...
image:/server/user_manual/_images/files_page-7.png[image]
...
image:/server/user_manual/_images/files_page-8.png[image]
