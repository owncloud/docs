...
[[virus-scanner-support_overview]]
== Overview
...
image:configuration/server/anti-virus-message-host-connection-problem.png[image]

image:configuration/server/anti-virus-message-misconfiguration-problem.png[image]

image:configuration/server/anti-virus-message-socket-connection-problem.png[image]
