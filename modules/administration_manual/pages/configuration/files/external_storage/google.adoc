...
image:google_drive/001.png[image]

image:google_drive/002.png[image]
...
image:google_drive/003.png[image]

After your project is created, click on the notifications bell and
select your project.

image:google_drive/004.png[image]

Go to Api overview to select google’s API.

image:google_drive/005.png[image]

image:google_drive/006.png[image]

image:google_drive/007.png[image]

Now you must create your credentials.

image:google_drive/008.png[image]

First, select ``Web Browser'' and ``User data''.

image:google_drive/009.png[image]

The next screen that opens is *Create OAuth 2.0 Client ID*. Enter your
app name.

image:google_drive/010.png[image]
...
image:google_drive/011.png[image]
...
image:google_drive/012.png[image]

image:google_drive/013.png[image]

image:google_drive/014.png[image]

image:google_drive/015.png[image]

image:google_drive/016.png[image]

Here is the correct result:

image:google_drive/017.png[image]
...
image:google_drive/018.png[image]

Now you can download the credentials as a JSON file.

image:google_drive/019.png[image]
...
image:google_drive/020.png[image]
...
image:google_drive/021.png[image]

When you see the green light confirming a successful connection you’re
finished.

image:google_drive/022.png[image]

image:google_drive/023.png[image]
