...
image:enterprise/external_storage/auth_backends-2.png[Global credentials form.]

Use the dropdown selector to choose the authentication backend when you
create a new external mount.

image:enterprise/external_storage/auth_backends.png[Authentication dropdown selector.]
