...
image:enterprise/external_storage/onedrive/register-an-application.png[image]
...
image:enterprise/external_storage/onedrive/set-application-name.png[image]
...
image:enterprise/external_storage/onedrive/set-redirect-urls.png[image]

[[application-permissions]]
=== Application Permissions

image:enterprise/external_storage/onedrive/set-permissions.png[image]
...
image:enterprise/external_storage/onedrive/configure-mountpoints.png[image]
