...
. Microsoft Office can be extended with the https://azure.microsoft.com/en-us/services/information-protection/[Microsoft Azure Information Protection] or the https://www.m-und-h.de/en-novapath/[NovaPath] add-ons, to provide classification capabilities.
...
To extend it, we recommend the https://azure.microsoft.com/en-us/services/information-protection/[Microsoft Azure Information Protection] or https://www.m-und-h.de/en-novapath/[NovaPath] add-ons.
