...
* xref:changes-in-10.0.10[Changes in 10.1]
...
**=> Please check .htaccess to make sure this**


=== Solved known issues

- LDAP users can upload avatars again [#33369]https://github.com/owncloud/core/issues/33369
- Versions list performance improvements [#33291]https://github.com/owncloud/core/issues/33291
- Improved compatibility with 3rd party WebDAV applications (fixed PROPFIND with depth infinity requests through Sabre update) [#28341]https://github.com/owncloud/core/issues/28341
- Fixed `occ encrypt-all` command to not attempt re-encrypting already encrypted files [#33206]https://github.com/owncloud/core/issues/33206

=== Known issues

Currently there are no known issues with ownCloud Server 10.1.
...
- Deprecate Sharing 1.0 PHP APIs which will be removed in ownCloud 11 - [#33220]https://github.com/owncloud/core/issues/33220
