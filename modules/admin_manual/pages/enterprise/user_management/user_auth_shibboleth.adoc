...
For this to work `userPrincipalName` needs to be added to the *User Search Attributes* in the LDAP directory settings on xref:configuration/user/user_auth_ldap.adoc[the advanced tab]. 
