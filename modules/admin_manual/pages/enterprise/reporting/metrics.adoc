...
Metrics app was desined for small deployments of ownCloud up to 250 Users.
On a big instance with more than 250 users it can take a very long time to gather the data.
You can speed this up by excluding userData and quota. 
