...
When you close the document, Microsoft Office Online also has a feature to unlock the file again so it can be edited by others again as you are done with it.
