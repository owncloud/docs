...
:officeonline-server: https://docs.microsoft.com/de-de/officeonlineserver/deploy-office-online-server
...
You need an {officeonline-server}[OfficeOnline Server] installed.
