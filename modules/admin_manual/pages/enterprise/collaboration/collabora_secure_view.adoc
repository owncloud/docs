...
* https://marketplace.owncloud.com/apps/onlyoffice[ONLYOFFICE]
* https://marketplace.owncloud.com/apps/wopi[Microsoft Office Online]
* https://marketplace.owncloud.com/apps/files_texteditor[Text editor]
