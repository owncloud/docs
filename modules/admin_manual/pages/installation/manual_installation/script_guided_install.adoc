...
At the end of the installation you should see a success message. If you installed with the default settings, you should be able to access your ownCloud instance via the browser at https://127.0.0.1/owncloud/ or localhost/owncloud/. Continue the setup via the graphical installation wizard. For more information, see xref:installation/installation_wizard.adoc.
