...
[source,console]
----
sudo sudo systemctl edit smbd.service
----

Add following content and save the result. The location and naming will be done automatically.
Just say save.
