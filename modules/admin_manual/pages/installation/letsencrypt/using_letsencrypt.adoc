...
* Create the following files in the Let’s Encrypt directory. They will help to maintain your certificates.
...
For example, the script could be renamed to `your-domain-name.com.sh`.
...
This file defines some default settings used by Certbot. Use the email address you registered with. Comment or uncomment the post-hook parameter depending on which web server you use.
