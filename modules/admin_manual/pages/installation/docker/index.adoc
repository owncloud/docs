...
If you only want to take a peek and are content with SQLite as database, which ist not supported by ownCloud and not recommended for production purposes, try the following:
