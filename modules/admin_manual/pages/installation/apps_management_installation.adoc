...
To install an app manually instead of by using the Market app, copy the app either into your ownCloud installation's default app folder (`</path/to/owncloud>/apps`) or, ideally, xref:using-custom-app-directories[a custom app directory].

Once the app folder has been copied into place:
