...
errors when there are additional headers set in the webservers configuration file like `http.conf`. More information on headers
can be found https://httpd.apache.org/docs/current/mod/mod_headers.html#page-header[here].
