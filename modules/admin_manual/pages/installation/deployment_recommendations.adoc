...
Use an off-the-shelf NFS solution, such as https://www.ibm.com/us-en/marketplace/ibm-elastic-storage-server[IBM Elastic Storage] or https://www.redhat.com/en/technologies/storage/ceph[RedHat Ceph].
