...
Previously ownCloud would have taken the files from the `apps/` folder even though there might be newer versions in e.g. `apps-external`. This has been changed for that ownCloud will always take the files from the most recent app version.
