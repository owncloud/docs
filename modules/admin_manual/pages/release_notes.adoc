...
With all these improvements we want to motivate ownCloud service providers to make ownCloud Web available to users, to experience the new technology as well as to provide feedback to further improve it. The ownCloud Web integration app comes as part of the 10.8 complete bundle. Furthermore, ownCloud Web has a release cycle of 3 weeks that is independent of ownCloud Server. This allows to get new versions with features, fixes and improvements regularly via the ownCloud Marketplace and to deploy them with minimal effort.
...
* https://marketplace.owncloud.com/web[Web] 3.3.0 (new addition to the bundle)
* https://marketplace.owncloud.com/files_antivirus[Anti-Virus] 1.0.0 (with https://owncloud.com/news/through-icap-owncloud-enterprise-now-works-with-the-major-names-in-anti-virus/[ICAP support])
* https://marketplace.owncloud.com/user_ldap[LDAP] 0.15.3
* https://marketplace.owncloud.com/activity[Activity] 2.6.1
* https://marketplace.owncloud.com/workflow[Workflow] 0.5.2
* https://marketplace.owncloud.com/announcementcenter[Announcement Center] 1.5.2
* https://marketplace.owncloud.com/customgroups[Custom Groups] 0.6.2
* https://marketplace.owncloud.com/files_lifecycle[File Lifecycle Management] 
* https://marketplace.owncloud.com/firewall[File Firewall] 2.10.3
* https://marketplace.owncloud.com/market[Market] 0.6.1
* https://marketplace.owncloud.com/admin_audit[Auditing] 2.1.3
* https://marketplace.owncloud.com/files_classifier[Document Classification] 1.3.1
* https://marketplace.owncloud.com/files_pdfviewer[PDF Viewer] 0.12.1
* https://marketplace.owncloud.com/files_texteditor[Text Editor] 2.3.1
* https://marketplace.owncloud.com/guests[Guests] 0.9.1
* https://marketplace.owncloud.com/wopi[Microsoft Office Online] 1.5.0
...
Currently there are no known issues with ownCloud Server 10.8. This section will be updated when more issues are discovered.
