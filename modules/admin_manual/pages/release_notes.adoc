...
* A new, improved version of the "Advanced Sharing Permissions" JavaScript API (v2) has been added to allow ownCloud apps to register additional permissions/restrictions in user/group sharing. 
