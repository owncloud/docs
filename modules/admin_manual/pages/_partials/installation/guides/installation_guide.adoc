...
[source,console,subs="attributes+"]
----
include::{examplesdir}installation/ubuntu/{distribution-version}/create-vhost-config.sh[]
----
...
[source,console,subs="attributes+"]
----
include::{examplesdir}installation/ubuntu/{distribution-version}/configure-log-rotation.sh[]
----
...
[source,console]
----
include::{examplesdir}installation/ubuntu/{distribution-version}/finalise-install.sh[]
----
