...
----
include::{examplesdir}installation/guides/ubuntu-18.04-ultra-short-install.sh[]
----
endif::[]
endif::[]
...
[source,console,subs="attributes+"]
----
include::{examplesdir}installation/guides/ubuntu/install-required-packages.sh[]
----
endif::[]
endif::[]
...
[source,console,subs="attributes+"]
----
include::{examplesdir}installation/guides/ubuntu/install-recommended-packages.sh[]
----
endif::[]
endif::[]
