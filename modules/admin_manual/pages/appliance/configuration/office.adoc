...
:onlyoffice-es-install-url: https://helpcenter.onlyoffice.com/installation/docs-enterprise-install-ubuntu.aspx
...
== Registering your ONLYOFFICE Enterprise Edition

If you purchased the ONLYOFFICE Enterprise Edition and received the `license.lic` file, you need to import it to unlock the enterprise features.

When you are a Debian based Linux distribution user, the `license.lic` file must be placed into the following folder:

----
/var/www/onlyoffice/Data/license.lic
----

Doing so, you will have access to the enterprise features of ONLYOFFICE.
