...
NOTE: In case you get an error trying to open a file: go to your owncloud-settings (Settings > Admin > Additional > Collabora-Online) 
and delete the port in the field "Collabora Online server".
