...
use the Appliance as your DNS server. Also make sure that your in your owncloud settings (Settings > Admin > Additional > Collabora-Online) 
u have defined the Collabora Online Server with the fqdn without tiping the port into the field.
