...
Here you can choose your **language**. Currently there are 2 options: English and German.
...
The second important setting during this setup: the **Administrator password**. You will need this to log in in to your appliance and administer it. So please **write this password down**. Setting your email address here is optional, since you can set it later on.
...
Here you get a finalized confirmation screen of what you have entered / set and you can finish the process. Note that if you let the ckeck box to update your system in - the installation will take **considerably longer**. Keep his in mind. You can apply the updates later on if you choose to skip it during the installation.
...
In the end you will see this screen informing you that the installation was successful.
