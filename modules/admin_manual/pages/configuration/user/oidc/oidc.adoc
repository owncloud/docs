...
NOTE: The desktop and mobile apps (clients) need to have the correct branding parameters and will most likely not work with the default client IDs in your environment. By design of OIDC, you have to build your own clients for every platform you want to roll out, or get in touch with ownCloud for a branding subscription to customize the clients according your needs.
