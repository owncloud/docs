...
ownCloud has the option to install a LDAP application called "LDAP Integration". You find it in the marketplace.
...
First, install the `LDAP Integration` app from the marketplace.
