...
See xref:installation/manual_installation/manual_installation.adoc[Manual Installation on Linux]
...
See xref:installation/manual_installation/manual_installation.adoc[Source Installation].
for instructions on how to install it.
|===
