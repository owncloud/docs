...
NOTE: If there is an error on the storage, it will be marked as unavailable for ten minutes.
...
IMPORTANT: Adding a storage for users or groups, you don't have access rights your self will result in an error notification and icon.
If you are sure, the configuration is correct, you can ignore these warnings.
