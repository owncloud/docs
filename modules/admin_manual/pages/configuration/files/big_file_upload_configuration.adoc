...
. In Apache systemd file e.g `systemctl edit httpd`:
+
----
PrivateTmp=false
----
Please do not change `/usr/lib/systemd/system/httpd.service` directly a httpd package upgrade may revert your changes
====
