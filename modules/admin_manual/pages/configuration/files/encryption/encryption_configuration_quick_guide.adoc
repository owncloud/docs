...
If you have an instance with a few users, you can use this example to decrypt the files.
Note that you have to enter the password for each user manually.
...
Access your database, select ownCloud and remove the remaining entries 
