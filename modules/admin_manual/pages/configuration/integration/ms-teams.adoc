...
=== Option 2 "Community": With basic authentication and ownCloud Community Edition
...
Note: If you are using the Community Edition, you can skip the following steps that describe the configuration of Azure AD and the MS-Teams Bridge App.
