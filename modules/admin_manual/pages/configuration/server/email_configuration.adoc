...
Same as with the SMPT configuration above, you must enter an email address where a test email will be sent to before testing the configuration. For details see the section above.
