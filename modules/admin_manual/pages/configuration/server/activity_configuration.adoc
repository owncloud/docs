...
Furthermore it is recommended to configure the https://doc.owncloud.com/server/{latest-version}/admin_manual/configuration/server/background_jobs_configuration.html#cron-jobs[background job] `Webcron`
or `Cron`.

There is also a https://doc.owncloud.com/server/{latest-version}/admin_manual/configuration/server/config_apps_sample_php_parameters.html#app-activityconfig.php[configuration option] `activity_expire_days` available in your `config.php` which allows you to
