...
|===
| `--export-masterkey` 
a| This command exports the base64-encoded representation of the private key in the ownCloud instance (not the one in the HSM). 

NOTE: The private key has the id of the private key in the HSM device. 
