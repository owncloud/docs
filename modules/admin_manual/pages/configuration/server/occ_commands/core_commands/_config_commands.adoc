...
Following apps, core functions or documents use/refer to `config:app` settings:
...
Following apps, core functions or documents use/refer to `config:system` settings:
