...
{icap-url}[ICAP] is an open standard supported by many antivirus products. With the release of the _Anti-Virus_ app 1.0.0, other virus scanners beside ClamAV can be used via ICAP if you are running it on an ownCloud Enterprise Edition. Currently the only supported virus scanners are _Kaspersky Anti-Virus_ and _McAfee Antivirus_ although far more products might simply work.

=== Installation

- Install the Anti-Virus app 1.0.0 from the {anti-virus-app-url}[ownCloud marketplace].

- Alternatively, use this occ command:
...
- Enable it as admin in ownCloud under Settings > Apps.
...
[source,console,subs="attributes+"]
----
{occ-command-example-prefix} occ config:app:set files_antivirus av_host --value="172.17.0.3"
----
...
[source,console,subs="attributes+"]
----
{occ-command-example-prefix} occ config:app:set files_antivirus av_port --value="1344"
----
...
[source,console,subs="attributes+"]
----
{occ-command-example-prefix} occ config:app:set files_antivirus av_mode --value="icap"
----
...
[source,console,subs="attributes+"]
----
{occ-command-example-prefix} occ config:app:set files_antivirus av_infected_action --value="delete"
----
...
[source,console,subs="attributes+"]
----
{occ-command-example-prefix} occ config:app:set files_antivirus av_response_header --value="X-Infection-Found"
----
...
Set KAV as virus scanner:

[source,console,subs="attributes+"]
----
{occ-command-example-prefix} occ config:app:set files_antivirus av_request_service --value="req"
----
...
[source,console,subs="attributes+"]
----
{occ-command-example-prefix} occ config:app:set files_antivirus av_response_header --value="X-Virus-ID"
----
