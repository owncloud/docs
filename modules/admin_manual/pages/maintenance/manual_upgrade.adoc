...
NOTE: How to get the correct link to the tar ball

- Login to **customer.owncloud.com** with your enterprise credentials 
- Navigate to the tar ball you want to download 
- **Right Click** on the **name of the file** and save the link location
