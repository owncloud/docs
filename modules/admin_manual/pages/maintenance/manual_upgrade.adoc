...
Change to the directory where occ is located, generally '/var/www/owncloud'
...
In some environments you may need to specifiy a path for the backup file, such as your home directory
...
Copy from your backup 'apps-external' directory to '/var/www/owncloud/'
