...
Download the latest https://owncloud.org/download/#owncloud-server-tar-ball[ownCloud server release] to where your previou installation was, in this example the default default directory `/var/www/`.
[source,console,subs="attributes+"]
----
cd /var/www/
