...
. the `config/` directory containing the main configuration file `config.php` plus sample configurations,
. the `data/` directory containing web-server-related files and `owncloud.log`,
