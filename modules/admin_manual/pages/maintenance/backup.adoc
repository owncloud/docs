...
When backing up your ownCloud server, there are four things you need to copy:

. the `config/` directory.
. the `data/` directory,
. a fresh ownCloud database dump,
. custom theme files if you have any, see xref:developer_manual:core/theming.adoc[Theming ownCloud].
