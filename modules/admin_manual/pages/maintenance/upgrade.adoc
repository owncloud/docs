...
NOTE: Enterprise customers will refer to Installing & Upgrading ownCloud Enterprise Edition for more information. Please see xref:enterprise/installation/install.adoc[Installing & Upgrading ownCloud Enterprise Edition] for more information.
