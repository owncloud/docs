...
However, xref:maintenance/manually-moving-data-folders.adoc[you can change it] before you begin the migration,
or after the migration’s completed.
...
After that’s done, wait for some minutes and stop your web server, in this case Apache:
