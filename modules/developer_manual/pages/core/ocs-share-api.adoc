...
[source,console]
----
include::example$core/scripts/curl/list-all-shares.sh[]
----
...
[source,php]
----
include::example$core/scripts/php/list-all-shares.php[]
----
...
[source,ruby]
----
include::example$core/scripts/ruby/list-all-shares.rb[]
----
...
[source,go]
----
include::example$core/scripts/go/list-all-shares.go[]
----
