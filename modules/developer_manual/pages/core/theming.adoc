...
NOTE: Before ownCloud 10 theming was done via config.php entry `'theme' => '',`. This is depricated in ownCloud 10.
Users who have this entry in their config.php can remove it and use a theme app to customize their ownCloud.
