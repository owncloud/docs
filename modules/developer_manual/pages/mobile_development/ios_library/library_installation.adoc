...
[[mobile-dev-ios-library-lib-installation_obtaining-the-library]]
...
[[mobile-dev-ios-library-lib-installation_add-the-library-to-a-project]]
...
[[mobile-dev-ios-library-lib-installation_reference-headers-and-library-binary-files]]
...
[[mobile-dev-ios-library-lib-installation_include-the-library-as-a-subproject]]
=== Include the library as a subproject
...
[[mobile-dev-ios-library-lib-installation_sources]]
== Sources
