...
[[mobile-dev-ios-library-examples_init-the-library]]
== Init the library
...
[[mobile-dev-ios-library-examples_code-example]]
=== Code example
...
[[mobile-dev-ios-library-examples_set-credentials]]
== Set credentials
...
[[mobile-dev-ios-library-examples_code-example-1]]
=== Code example
...
[[mobile-dev-ios-library-examples_read-folder]]
== Read folder
...
[[mobile-dev-ios-library-examples_code-example-3]]
=== Code example
...
[[mobile-dev-ios-library-examples_read-file]]
== Read file
...
[[mobile-dev-ios-library-examples_code-example-4]]
=== Code example
...
[[mobile-dev-ios-library-examples_move-file-or-folder]]
== Move file or folder
...
[[mobile-dev-ios-library-examples_code-example-5]]
=== Code example
...
[[mobile-dev-ios-library-examples_delete-file-or-folder]]
== Delete file or folder

Delete a file or folder on the cloud server. The info needed is the path
to delete.

[[mobile-dev-ios-library-examples_code-example-6]]
=== Code example
...
[[mobile-dev-ios-library-examples_download-a-file]]
== Download a file
...
[[mobile-dev-ios-library-examples_code-example-7]]
=== Code example
...
[[mobile-dev-ios-library-examples_download-a-file-with-background-session]]
...
[[mobile-dev-ios-library-examples_code-example-8]]
=== Code example
...
[[mobile-dev-ios-library-examples_set-callback-when-background-download-task-finishes]]
...
[[mobile-dev-ios-library-examples_code-example-9]]
=== Code example
...
[[mobile-dev-ios-library-examples_set-progress-callback-with-pending-background-download-tasks]]
...
[[mobile-dev-ios-library-examples_code-example-10]]
=== Code example
...
[[mobile-dev-ios-library-examples_upload-a-file]]
== Upload a file
...
[[mobile-dev-ios-library-examples_code-example-11]]
=== Code example
...
[[mobile-dev-ios-library-examples_upload-a-file-with-background-session]]
...
[[mobile-dev-ios-library-examples_code-example-12]]
=== Code example
...
[[mobile-dev-ios-library-examples_set-callback-when-background-task-finish]]
...
[[mobile-dev-ios-library-examples_code-example-13]]
=== Code example
...
[[mobile-dev-ios-library-examples_set-progress-callback-with-pending-background-tasks]]
...
[[mobile-dev-ios-library-examples_code-example-14]]
=== Code example
...
[[mobile-dev-ios-library-examples_check-if-the-server-supports-sharing-api]]
...
[[mobile-dev-ios-library-examples_code-example-15]]
=== Code Example
...
[[mobile-dev-ios-library-examples_read-shared-all-items-by-link]]
...
[[mobile-dev-ios-library-examples_code-example-16]]
=== Code example
...
[[mobile-dev-ios-library-examples_read-shared-items-by-link-of-a-path]]
...
[[mobile-dev-ios-library-examples_code-example-17]]
=== Code example
...
[[mobile-dev-ios-library-examples_share-link-of-file-or-folder]]
...
[[mobile-dev-ios-library-examples_code-example-18]]
=== Code example
...
[[mobile-dev-ios-library-examples_unshare-a-folder-or-file-by-link]]
...
[[mobile-dev-ios-library-examples_code-example-19]]
=== Code example
...
[[mobile-dev-ios-library-examples_check-if-file-of-folder-is-shared]]
...
[[mobile-dev-ios-library-examples_code-example-20]]
=== Code example
...
[[mobile-dev-ios-library-examples_tips]]
== Tips
