...
The script also lists the quantity and commits to be backported and the current one in process.
...
to set the Pull Request title and description text manually via copy/paste.
...
If you want to integrate the script into git, you can use an alias.
Open the `~/.gitconfig` with your editor of choice and add the following
