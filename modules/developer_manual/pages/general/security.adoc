...
[[security-guidelines_introduction]]
== Introduction
...
[[security-guidelines_general]]
== General

[[security-guidelines_source-code-analysis]]
...
[[security-guidelines_architecture]]
== Architecture

[[security-guidelines_security-related-comments-in-source-code]]
...
[[security-guidelines_http-or-https]]
=== HTTP or HTTPS
...
[[security-guidelines_security-related-actions]]
...
[[security-guidelines_browser-plugins]]
=== Browser plugins
...
[[security-guidelines_least-privilege-principle]]
...
[[security-guidelines_error-messages-and-error-pages]]
...
[[security-guidelines_access-protection-with-authorization-checks]]
...
[[security-guidelines_path-traversal-and-path-manipulation]]
...
[[security-guidelines_prevent-command-injection]]
...
[[security-guidelines_output-escaping]]
=== Output Escaping
...
[[security-guidelines_high-sensitive-information-in-get-request]]
...
[[security-guidelines_prevent-http-header-injection-http-response-splitting]]
...
[[security-guidelines_changes-on-the-document-object-model-dom]]
...
[[security-guidelines_prevent-sql-injection]]
...
[[security-guidelines_data-storage]]
== Data Storage

[[security-guidelines_persistent-storages-on-client-side]]
...
[[security-guidelines_release-all-resources-in-case-of-an-error]]
...
[[security-guidelines_cryptography]]
== Cryptography

[[security-guidelines_symmetric-encryption-methods]]
...
[[security-guidelines_asymmetric-encryption-methods]]
=== Asymmetric Encryption Methods

* If you use asymmetric encryption methods, use RSA encryption with a
key length of 4096.

[[security-guidelines_hash-algorithms]]
=== Hash Algorithms
...
[[security-guidelines_cookies]]
== Cookies

[[security-guidelines_secure-flag]]
=== Secure Flag
...
[[security-guidelines_password-length]]
=== Password Length
...
[[security-guidelines_user-interface]]
== User Interface

[[security-guidelines_input-auto-completion]]
...
[[security-guidelines_attack-vectors]]
== Attack Vectors

[[security-guidelines_auth-bypass-privilege-escalations]]
...
[[security-guidelines_clickjacking]]
=== Clickjacking
...
[[security-guidelines_code-executions-file-inclusions]]
...
[[security-guidelines_cross-site-request-forgery]]
...
[[security-guidelines_cross-site-scripting]]
...
[[security-guidelines_javascript]]
=== JavaScript
...
[[security-guidelines_directory-traversal]]
=== Directory Traversal
...
[[security-guidelines_shell-injection]]
=== Shell Injection
...
[[security-guidelines_sensitive-data-exposure]]
...
[[security-guidelines_sql-injection]]
=== SQL Injection
...
[[security-guidelines_unvalidated-redirects]]
...
[[security-guidelines_getting-help]]
== Getting Help
