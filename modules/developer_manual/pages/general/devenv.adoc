...
xref:administration_manual:installation/manual_installation.adoc#install-the-required-packages[the required packages].
...
* xref:administration_manual:installation/manual_installation.adoc#apache-configuration-label[Apache Webserver Configuration]
* xref:administration_manual:configuration/database/linux_database_configuration.adoc[Database Server Configuration]
...
1.  Use a xref:administration_manual:installation/manual_installation.adoc#manual-installation-on-linux[manual installation]
2.  Use a xref:administration_manual:installation/linux_installation.adoc[Linux Package Manager Installation]
