...
Below is an EER (Enhanced Entity Relationship) diagram of the default ownCloud database schema.

.An EER diagram of the default ownCloud database schema
image::app/fundamentals/database/database-model.png[EER diagram of the default ownCloud database schema]