...
[[external-storage-backends-configure-the-filesystem-type]]
== Configure the filesystem type

First, the /appinfo/info.xml must be adjusted to specify the `type` as:
`filesystem`. For example:

[[external-storage-backends-implement-the-storage-classes]]
...
[[external-storage-backends-statmetadata-cache]]
=== Stat/metadata cache
...
[[external-storage-backends-writing-a-flysystem-adapter]]
...
[[external-storage-backends-create-the-backend-adapter]]
...
[[external-storage-backends-definition-parameters]]
=== Definition parameters

[[external-storage-backends-flags]]
==== Flags:
...
[[external-storage-backends-types]]
==== Types:
...
[[external-storage-backends-authentication-schemes]]
...
[[external-storage-backends-custom-user-interface]]
...
[[external-storage-backends-register-the-backend-adapter]]
...
[[external-storage-backends-test-the-storage-backend]]
